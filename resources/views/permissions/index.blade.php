          ...
          <div class="col-12">
            ...
            <div class="card card-outline card-primary collapsed-card">
                ...
                <div class="card-body" style="display: none;">
                  {!! Form::open(['method' => 'GET', 'class' => '' ,'route' => ['permissions.index']]) !!}
                    <div class="row">
                      <div class="col-3">
            ...
            <div class="card card-outline card-primary">
              <div class="card-header">
                <h3 class="card-title">Permissions
                    <small>Manage your permissions here.</small>
                </h3>

                <div class="card-tools">
                    <a href="{{ route('permissions.create') }}" class="btn btn-primary btn-card-header" title="Add permissions"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add New permissions</a>
                ...
                <table id="data_table" class="table table-bordered table-striped data-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        {!! Form::open(['method' => 'DELETE', 'class' => 'delete-form' ,'route' => ['permissions.destroy', $permission->id]]) !!}
